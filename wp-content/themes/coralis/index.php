...
<div id="content">
    ...
    <div class="alignleft"><h5><?php next_posts_link('<b>&laquo; Older Entries</b>') ?></h5></div>
			<div class="alignright"><h5><?php previous_posts_link('<b>Newer Entries &raquo;</b>') ?></h5></div>
