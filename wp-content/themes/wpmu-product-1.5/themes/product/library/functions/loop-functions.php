...
function bp_wpmu_blogpage_loop(){
		...
		<div class="post" id="post-<?php the_ID(); ?>">
			<div class="author-box">
				...
				<p><?php _e( 'by ', TEMPLATE_DOMAIN ) ?><?php the_author_link();  ?></p>
			</div>
			<div class="post-content">
				...
				<p class="date"><?php the_time('M j Y') ?> <em><?php _e( 'in', TEMPLATE_DOMAIN ) ?> <?php the_category(', ') ?> <?php _e( 'by ', TEMPLATE_DOMAIN ) ?><?php the_author_link();  ?></em></p>
				<div class="entry">
