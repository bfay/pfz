<?php if (is_single()) { ?>
		<div class="post" id="post-<?php the_ID(); ?>">
			<div class="author-box">
				...
				<p><?php printf( __( 'by %s', TEMPLATE_DOMAIN ), bp_core_get_userlink( $post->post_author ) ) ?></p>
			</div>
			<div class="post-content">
				...
				<p class="date"><?php the_time('F j, Y') ?> <em><?php _e( 'in', TEMPLATE_DOMAIN ) ?> <?php the_category(', ') ?> <?php printf( __( 'by %s', TEMPLATE_DOMAIN ), bp_core_get_userlink( $post->post_author ) ) ?></em></p>
				<div class="entry">
...
<?php } else if (is_page()) { ?>
			...
			<div class="post" id="post-<?php the_ID(); ?>">
				<div class="entry">
					<?php the_content( __( '<p class="serif">Read the rest of this page &rarr;</p>', TEMPLATE_DOMAIN ) ); ?>
