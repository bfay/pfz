...
#nav-1 li li li a .sf-sub-indicator {
	background: url(images/' . $nav1_sub_indicator_image . ') no-repeat;
...
#nav-2 li li li a .sf-sub-indicator {
	background: url(images/' . $nav2_sub_indicator_image . ') no-repeat;
