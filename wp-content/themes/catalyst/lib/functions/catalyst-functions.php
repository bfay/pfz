...
/**
 * Turn on gzip compression if the zlib extension is loaded
 * and if gzip is enabled in Core Options.
 *
 * @since 1.0
 * @return true or false depending on settings.
 */
function catalyst_gzip()
{
	if( !catalyst_get_core( 'gzip_compression_enable' ) || function_exists( 'custom_enable_gzip' ) )
		return false;
