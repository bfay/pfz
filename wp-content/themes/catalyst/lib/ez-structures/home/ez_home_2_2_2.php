<?php
/**
 * Build and register the ez_home_2_2_2 widget areas.
 *
 * @package Catalyst
 */
...
/**
 * Build the ez home 2 2 2 HTML.
 *
 * @since 1.1
 */
function ez_home_2_2_2()
{
	...
	<div id="ez-home-container-wrap" class="clearfix">
		...
		<div id="ez-home-middle-container" class="ez-home-container-area clearfix">
			...
			<div id="ez-home-middle-1" class="ez-widget-area ez-home-widget-area  ez-one-half ez-first">
				<?php
			...
			<div id="ez-home-middle-2" class="ez-widget-area ez-home-widget-area  ez-one-half">
				<?php
