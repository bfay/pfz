<?php
/**
 * Build and register the ez_home_2_3_1 widget areas.
 *
 * @package Catalyst
 */
...
/**
 * Build the ez home 2 3 1 HTML.
 *
 * @since 1.1
 */
function ez_home_2_3_1()
{
	...
	<div id="ez-home-container-wrap" class="clearfix">
		...
		<div id="ez-home-bottom-container" class="ez-home-container-area ez-home-bottom clearfix">
			...
			<div id="ez-home-bottom-1" class="ez-widget-area ez-home-widget-area  ez-only">
				<?php
