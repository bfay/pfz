<?php
/**
 * Build and register the ez_home_2_3_2 widget areas.
 *
 * @package Catalyst
 */
...
catalyst_register_sidebar( array(
	'name'=>'EZ Home Middle #2',
	'id' => 'catalyst_ez_home_middle_2'
));
catalyst_register_sidebar( array(
	'name'=>'EZ Home Middle #3',
	'id' => 'catalyst_ez_home_middle_3'
));
catalyst_register_sidebar( array(
...
/**
 * Build the ez home 2 3 2 HTML.
 *
 * @since 1.1
 */
function ez_home_2_3_2()
{
	...
	<div id="ez-home-container-wrap" class="clearfix">
		...
		<div id="ez-home-top-container" class="ez-home-container-area clearfix">
			...
			<div id="ez-home-top-1" class="ez-widget-area ez-home-widget-area  ez-one-half ez-first">
				<?php
			...
			<div id="ez-home-top-2" class="ez-widget-area ez-home-widget-area  ez-one-half">
				<?php
		...
		<div id="ez-home-middle-container" class="ez-home-container-area clearfix">
			...
			<div id="ez-home-middle-1" class="ez-widget-area ez-home-widget-area  ez-one-third ez-first">
				<?php
			...
			<div id="ez-home-middle-2" class="ez-widget-area ez-home-widget-area  ez-one-third">
				<?php
				if( !dynamic_sidebar( 'EZ Home Middle #2' ) )
				{
				?>
					<aside class="widget">
						<h4><?php _e( 'EZ Home Middle #2', 'catalyst' ); ?></h4>
						<p><?php printf( __( 'This is Catalyst Widget Area. You can add content to this area by going to <a href="%s">Appearance > Widgets</a> in your WordPress Dashboard and adding new widgets to this area.', 'catalyst' ), admin_url( 'widgets.php' ) ); ?></p>
					</aside>			
				<?php
				}
			...
			<div id="ez-home-middle-3" class="ez-widget-area ez-home-widget-area  ez-one-third">
				<?php
				if( !dynamic_sidebar( 'EZ Home Middle #3' ) )
				{
				?>
					<aside class="widget">
						<h4><?php _e( 'EZ Home Middle #3', 'catalyst' ); ?></h4>
						<p><?php printf( __( 'This is Catalyst Widget Area. You can add content to this area by going to <a href="%s">Appearance > Widgets</a> in your WordPress Dashboard and adding new widgets to this area.', 'catalyst' ), admin_url( 'widgets.php' ) ); ?></p>
					</aside>			
				<?php
				}
		...
		<div id="ez-home-bottom-container" class="ez-home-container-area ez-home-bottom clearfix">
			...
			<div id="ez-home-bottom-1" class="ez-widget-area ez-home-widget-area  ez-one-half ez-first">
				<?php
			...
			<div id="ez-home-bottom-2" class="ez-widget-area ez-home-widget-area  ez-one-half">
				<?php
