<?php
/**
 * Build and register the ez_home_wide_left_3_3_2 widget areas.
 *
 * @package Catalyst
 */
 ...
 * @since 1.1
 */
function ez_home_wide_left_3_3_2()
{
	...
	<div id="ez-home-container-wrap" class="clearfix">
		...
		<div id="ez-home-bottom-container" class="ez-home-container-area ez-home-bottom clearfix">
			...
			<div id="ez-home-bottom-1" class="ez-widget-area ez-home-widget-area  ez-two-thirds ez-first">
				<?php
