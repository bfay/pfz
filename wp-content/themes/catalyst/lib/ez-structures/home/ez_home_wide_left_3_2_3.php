<?php
/**
 * Build and register the ez_home_wide_left_3_2_3 widget areas.
 *
 * @package Catalyst
 */
 ...
 * @since 1.1
 */
function ez_home_wide_left_3_2_3()
{
	...
	<div id="ez-home-container-wrap" class="clearfix">
		...
		<div id="ez-home-middle-container" class="ez-home-container-area clearfix">
			...
			<div id="ez-home-middle-1" class="ez-widget-area ez-home-widget-area  ez-two-thirds ez-first">
				<?php
