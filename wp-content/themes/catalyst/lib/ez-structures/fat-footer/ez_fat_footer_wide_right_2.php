<?php
/**
 * Build and register the ez_fat_footer_wide_right_2 widget areas.
 *
 * @package Catalyst
 */
...
/**
 * Build the ez fat footer wide right 2 HTML.
 *
 * @since 1.1
 */
function ez_fat_footer_wide_right_2()
{
?>
	<div id="ez-fat-footer-container-wrap" class="clearfix">
		...
		<div id="ez-fat-footer-container" class="clearfix">
			...
			<div id="ez-fat-footer-2" class="ez-widget-area ez-fat-footer-widget-area  ez-two-thirds">
				<?php
