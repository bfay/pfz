<?php
/**
 * Build and register the ez_feature_top_2 widget areas.
 *
 * @package Catalyst
 */
...
/**
 * Build the ez feature top 2 HTML.
 *
 * @since 1.1
 */
function ez_feature_top_2()
{
?>
	<div id="ez-feature-top-container-wrap" class="clearfix">
		...
		<div id="ez-feature-top-container" class="clearfix">
			...
			<div id="ez-feature-top-1" class="ez-widget-area ez-feature-top-widget-area  ez-one-half ez-first">
				<?php
			...
			<div id="ez-feature-top-2" class="ez-widget-area ez-feature-top-widget-area  ez-one-half">
				<?php
