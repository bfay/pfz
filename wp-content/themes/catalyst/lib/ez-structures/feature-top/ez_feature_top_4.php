<?php
/**
 * Build and register the ez_feature_top_4 widget areas.
 *
 * @package Catalyst
 */
...
catalyst_register_sidebar( array(
	'name'=>'EZ Feature Top #4',
	'id' => 'catalyst_ez_feature_top_4'
));

/**
 * Build the ez feature top 4 HTML.
 *
 * @since 1.1
 */
function ez_feature_top_4()
{
?>
	<div id="ez-feature-top-container-wrap" class="clearfix">
		...
		<div id="ez-feature-top-container" class="clearfix">
			...
			<div id="ez-feature-top-1" class="ez-widget-area ez-feature-top-widget-area  ez-one-fourth ez-first">
				<?php
			...
			<div id="ez-feature-top-2" class="ez-widget-area ez-feature-top-widget-area  ez-one-fourth">
				<?php
			...
			<div id="ez-feature-top-3" class="ez-widget-area ez-feature-top-widget-area  ez-one-fourth">
				<?php
			...
			<div id="ez-feature-top-4" class="ez-widget-area ez-feature-top-widget-area  ez-one-fourth">
				<?php
				if( !dynamic_sidebar( 'EZ Feature Top #4' ) )
				{
				?>
					<aside class="widget">
						<h4><?php _e( 'EZ Feature Top #4', 'catalyst' ); ?></h4>
						<p><?php printf( __( 'This is Catalyst Widget Area. You can add content to this area by going to <a href="%s">Appearance > Widgets</a> in your WordPress Dashboard and adding new widgets to this area.', 'catalyst' ), admin_url( 'widgets.php' ) ); ?></p>
					</aside>			
				<?php
				}
				?>
			</div><!-- end #feature-top-4 -->
