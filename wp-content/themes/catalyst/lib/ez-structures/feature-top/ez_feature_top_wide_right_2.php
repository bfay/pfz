<?php
/**
 * Build and register the ez_feature_top_wide_right_2 widget areas.
 *
 * @package Catalyst
 */
...
/**
 * Build the ez feature top wide right 2 HTML.
 *
 * @since 1.1
 */
function ez_feature_top_wide_right_2()
{
?>
	<div id="ez-feature-top-container-wrap" class="clearfix">
		...
		<div id="ez-feature-top-container" class="clearfix">
			...
			<div id="ez-feature-top-2" class="ez-widget-area ez-feature-top-widget-area  ez-two-thirds">
				<?php
