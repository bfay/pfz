...
<div id="catalyst-advanced-options-nav-hook-boxes-box" class="catalyst-optionbox-outer-1col catalyst-all-options">
	<div class="catalyst-optionbox-inner-1col">
		<h3><?php _e( 'Custom Hook Boxes', 'catalyst' ); ?><span style="margin:0 10px 0 -75px !important; font-weight:normal; float:right;" class="button add-hook"><?php _e( 'Add', 'catalyst' ); ?></span> <span id="custom-hooks-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
