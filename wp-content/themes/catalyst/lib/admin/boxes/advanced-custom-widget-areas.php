...
<div id="catalyst-advanced-options-nav-widget-areas-box" class="catalyst-optionbox-outer-1col catalyst-all-options">
	<div class="catalyst-optionbox-inner-1col">
		<h3><?php _e( 'Custom Widget Areas', 'catalyst' ); ?><span style="margin:0 10px 0 -75px !important; font-weight:normal; float:right;" class="button add-widget"><?php _e( 'Add', 'catalyst' ); ?></span> <span id="custom-widgets-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
