...
<div id="catalyst-advanced-options-nav-layouts-box" class="catalyst-optionbox-outer-1col catalyst-all-options catalyst-options-display">
	<div class="catalyst-optionbox-inner-1col">
		...
		<?php } ?>
		<span style="margin:0 10px 0 -75px !important; font-weight:normal; float:right;" class="button add-layout"><?php _e( 'Add', 'catalyst' ); ?></span><span id="custom-layouts-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
