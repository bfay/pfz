...
<div id="catalyst-core-options-nav-content-box" class="catalyst-all-options">
	...
	<div class="catalyst-optionbox-2col-right-wrap">
		...
		<div class="catalyst-optionbox-outer-2col">
			<div class="catalyst-optionbox-inner-2col">
				<h4><?php _e( 'Content Encoding Options', 'catalyst' ); ?></h4>
				<div class="bg-box">
					<p>
						<input type="checkbox" id="catalyst-gzip-compression-enable" name="catalyst[gzip_compression_enable]" value="1" <?php if( checked( 1, catalyst_get_core( 'gzip_compression_enable' ) ) ); ?> /> <?php _e( 'Enable gzip Compression.', 'catalyst' ); ?>
						<span id="gzip-enable-tooltip" class="tooltip-mark tooltip-top-left">[Read This First]</span>
					</p>
					
					<div class="tooltip tooltip-400">
						<p>
							<?php _e( 'Gzip compression can help make your site more effecient. The only reason we do not enable this by default, however, is because in some cases gzip can cause issues or conflicts with specific web servers and/or WordPress Plugins.', 'catalyst' ); ?>
						</p>
						...
						<span class="tooltip-credit">
							<?php _e( 'Learn more about gzip here:', 'catalyst' ); ?>
							<a href="http://code.google.com/speed/articles/gzip.html" target="_blank">How gzip compression works</a>
						</span>
					</div>
				</div>
			</div>
