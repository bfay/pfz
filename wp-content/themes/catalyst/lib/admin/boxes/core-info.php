...
<div id="catalyst-core-options-nav-info-box" class="catalyst-all-options catalyst-options-display">
	<?php $child_info = get_theme_data( CHILD_ROOT . '/style.css' ); ?>
		...
		<div class="catalyst-optionbox-outer-2col">
			<div class="catalyst-optionbox-inner-2col">
				...
				<div class="bg-box">
					...
					<p>
						<?php _e( 'Child Theme Version:', 'catalyst' ); ?> <b><code><?php echo esc_attr($child_info['Name']) . ' ' . esc_attr($child_info['Version']) ?></code></b>
					</p>
					<?php } ?>
				</div>
			</div>
