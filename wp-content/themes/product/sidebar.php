...
<div id="sidebar">
	<div class="padder">
		<div class="sidebar-box">
								...
								|| !dynamic_sidebar('memberleft-sidebar') ) : ?>
											<div class="widget-error">
												<?php _e( 'Please log in and add widgets to this column.', 'buddypress' ) ?> <a href="<?php echo get_option('siteurl') ?>/wp-admin/widgets.php?s=&amp;show=&amp;sidebar=memberleft-sidebar"><?php _e( 'Add Widgets', 'buddypress' ) ?></a>
											</div>
								<?php endif; ?>
		</div>
			...
			<div class="sidebar-box">
							<?php if ( !function_exists('dynamic_sidebar')
							|| !dynamic_sidebar('membermiddle-sidebar') ) : ?>
										<div class="widget-error">
											<?php _e( 'Please log in and add widgets to this column.', 'buddypress' ) ?> <a href="<?php echo get_option('siteurl') ?>/wp-admin/widgets.php?s=&amp;show=&amp;sidebar=membermiddle-sidebar"><?php _e( 'Add Widgets', 'buddypress' ) ?></a>
										</div>
							<?php endif; ?>			</div>
